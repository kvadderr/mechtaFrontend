                ...
                <div className="basket__offer">
                    ...
                    <div className="basket__offer-container basket__offer-container--summary-info">
                        ...
                        <div className="basket__summary-info">
                            ...
                            <div class="basket__summary-info-descr">Быстро</div>
                        </div>
                        <div class="basket__summary-info">
                            <div class="basket__summary-info-title">Адрес доставки</div>
                            <div class="basket__summary-info-descr">Санкт-Петербург, Садовая, 28-30 к1</div>
                        </div>
                    </div>
